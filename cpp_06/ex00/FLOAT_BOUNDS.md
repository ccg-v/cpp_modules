...
* Representation of Large Numbers:
    ...
    However, because of the limited precision (23 bits for the significand), <i>any number that is close to FLT_MAX might get rounded off to the nearest representable float value</i>. This is why numbers that should theoretically be distinct might be represented as the same float value.
