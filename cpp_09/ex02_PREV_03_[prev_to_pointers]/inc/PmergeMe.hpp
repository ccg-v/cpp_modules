...
/*   Updated: 2024/11/30 00:52:10 by ccarrace         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class PmergeMe {
	...
	private:
		...
		std::vector<t_pair>	_pairStraggler;
		...
		void				recursiveSort(std::vector<t_pair> & seq, std::vector<t_pair> & mainChain, std::vector<t_pair> & pending, std::vector<int> & pairPositions, size_t & comparisons);
		...
		void	pairMergeInsertion(std::vector<t_pair> & pending, std::vector<t_pair> & mainChain, std::vector<int> & pairPositions, size_t & comparisons);	
